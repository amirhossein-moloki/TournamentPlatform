...
// Removed direct instantiation of repositories and use cases.
...
// User Game Profiles routes will be added here by the factory function
// For example:
// router.post('/me/game-profiles', authenticateToken, userGameProfileController.upsertProfile);
// router.get('/me/game-profiles', authenticateToken, userGameProfileController.getProfiles);
// router.get('/me/game-profiles/:gameId', authenticateToken, userGameProfileController.getProfileForGame);


// module.exports = router; // Will be exported by the factory
